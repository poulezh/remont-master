    ...
    <div class="container">
        <div class="pages__inner">
            ...
            <p class="pages__text">
                ...
                Обычно выезд, замер и составление сметы это бесплатная услуга. У нас она точно <b>БЕСПЛАТНАЯ</b>.
...
<section class="optimize">
    <div class="container">
        <div class="optimize__inner">
            ...
            <h2 class="optimize__title">Ремонт квартиры это просто!</h2>
            <p class="optimize__text">Мы делаем ремонт квартир простым и легким для вас. Вы не думаете о том, каким образом будет проходить ремонт и как это все будет организовано. Это все мы делаем за вас, а вы только
            наблюдаете за результатом и принимаете выполненную работу.</p>
